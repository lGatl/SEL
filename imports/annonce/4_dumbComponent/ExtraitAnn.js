...
export default class ExtraitAnn extends Component {
	...
	render(){
		const { type, categorie, titre, description, date, statut, montree } = this.props;

		return(

			<Segment row style={{height:200,...this.props.style}} > 
				<div style={{background:"url('/images/1.jpg') no-repeat center center",backgroundSize: "cover", maxWidth:200, display:"flex", flex:4}}>
				</div>
				
				<div style={{display:"flex", flexDirection:"column", flex:7, cursor:"pointer", marginLeft:5,}} onClick={this.props.goAnnonce.bind(this)}>
					<div style={{
						fontSize:16,
						marginTop:5,
				...
				<div style={{display:"flex", flexDirection:"column", width:40}}>
					...
					<div style = {{display: "flex", flex:2, flexDirection:"column", justifyContent:"flex-end", alignItems:"center", 
						cursor:"pointer" }} 
